#
#  Be sure to run `pod spec lint cocoapods-playground.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "cocoapods-playground"
  spec.version      = "1.0.0"
  ...
  spec.source       = { :git => "https://github.com/oscarvillagrana/cocoapods-playground.git", :tag => "#{spec.version}" }
